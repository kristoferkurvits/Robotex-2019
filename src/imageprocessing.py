...
def start(processes_variables):
    ...
    while True:
        ...
        try:
            ...
            """
            bounds_x, bounds_y, bounds_r, mask_bounds = vision.find_bounds(hsv)

            bounds_x = int(bounds_x)
            bounds_y = int(bounds_y)
            bounds_r = int(bounds_r)
            """
            ...
            #cv2.line(frame, (int(bounds_x), int(bounds_y)), (int(bounds_x), int(bounds_y)), (150, 0, 255), 8)
